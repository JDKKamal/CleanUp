...
public class ModelCustomerList
{
    ...
    public ModelCustomerList(String uid, String customerid, String firstname, String lastname, String email, String mobile, String city, String location, String address, String pincode, String date) {
        this.uid = uid;
