...
public class LeadListAdapter extends RecyclerView.Adapter<LeadListAdapter.ViewHolder> {
    ...
    public LeadListAdapter(Activity activity, List<ModelLeadList> alLeadList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.itemview_lead_list, parent, false));
    }
