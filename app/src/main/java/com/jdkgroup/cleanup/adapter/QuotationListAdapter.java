...
public class QuotationListAdapter extends RecyclerView.Adapter<QuotationListAdapter.ViewHolder> {
    ...
    public QuotationListAdapter(Activity activity, List<ModelLeadList> alLeadList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.itemview_quotation_list, parent, false));
    }
